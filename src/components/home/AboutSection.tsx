        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              ...
              <img 
                ...
                alt="Polet Beauty - קוסמטיקאית ומאפרת מקצועית"
          ...
          <div className="max-w-xl">
            <span className="text-primary/70 font-semibold tracking-wider uppercase text-sm mb-4 block">קצת עליי</span>
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary leading-tight mb-8">
              POLET BEAUTY <br /> 
              <span className="text-primary/60 underline decoration-primary/20 decoration-4 underline-offset-8 decoration-wavy small-caps">קוסמטיקאית ומאפרת מקצועית</span>
            </h2>
